...
import { Trophy, Sparkles, ChevronLeft, ChevronRight, ArrowLeft, Medal } from 'lucide-react';
        ...
        <div className="w-full max-w-5xl mx-auto mb-12 relative rounded-3xl overflow-hidden border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] bg-brand-card h-[340px] sm:h-[400px] md:h-[440px]">
          ...
          <div className="w-full h-full relative overflow-hidden">
            {slides.map((slide, sIdx) => {
              ...
              // Calculate slide translate styles for horizontal slide animation
              let transformStyle = 'translate-x-full'; // default next incoming slide position
              if (isActive) {
                      ...
                      <div className="relative z-10 w-full max-w-3xl mx-auto space-y-4 sm:space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-3.5 sm:gap-6 items-end w-full max-w-lg mx-auto pt-2 select-none">
                          ...
                          <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                            ...
                            <h4 className="text-white text-[11px] sm:text-xs font-black truncate w-full">Ayush Kumar</h4>
                          ...
                          <div className="flex flex-col items-center gap-1.5 sm:gap-2 relative">
                            <div className="absolute -top-5 bg-brand-gold text-[7px] text-[#0D0D11] font-black px-2 py-0.5 rounded-full uppercase tracking-wider shadow-sm">
                              Joint
                            </div>
                            <span className="text-[9px] font-black text-brand-gold tracking-wider">1ST PLACE</span>
                            <h4 className="text-white text-[11px] sm:text-xs font-black truncate w-full">Harsh & Ankit</h4>
                            <span className="text-[10px] font-extrabold text-brand-gold">₹25,000 Each</span>
