  ...
  const guidelines = [
    {
      ...
      badge: "Mandatory",
      cardBg: "bg-[#FFE8D6]",
      borderColor: "border-[#8C3A16]",
      badgeStyle: "bg-[#8C3A16]/15 text-[#8C3A16] border-[#8C3A16]/30",
      stageBadge: "bg-[#8C3A16] text-white",
      titleColor: "text-[#5C230C]",
      descColor: "text-[#241708]",
      bulletDot: "bg-[#C97F1B]",
      buttonColor: "bg-gradient-to-r from-[#8C3A16] via-[#A64B1E] to-[#C97F1B] text-white shadow-md",
      bullets: [
